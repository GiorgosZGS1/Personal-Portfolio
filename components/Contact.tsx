  ...
  return (
    <div className="wrapper">
      <div className="max-w-5xl mx-auto flex flex-col gap-4 items-center justify-center">
        <h2 className="text-2xl font-bold text-center">Got a cool idea? I can help you.</h2>
        <p className="text-md tracking-wide  text-center">
        ...
        <a href="mailto:giorgosz21@hotmail.com">
      ...
      <div className="mt-8 flex items-center flex-wrap   gap-8 justify-center">
        <SocialLink title="Github" link="https://github.com/GiorgosZGS1" />
        <SocialLink
          title="Linkedin"
          link="https://www.linkedin.com/in/giorgos-zagaris-9b03061ba/"
        />
        <SocialLink
          title="Facebook"
          link=""
